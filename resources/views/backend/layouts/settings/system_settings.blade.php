...
@push('styles')
    <style>
        .white_logos .dropify-wrapper .dropify-preview {
            background-color: #f0f0f0;
            /* light gray background */
        }

        .white_logos .dropify-wrapper .dropify-preview .dropify-render img {
            background-color: #f0f0f0;
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('system.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group white_logos">
                                    <label for="white_logo" class="form-label">Logo white:</label>
                                    {{-- <input type="hidden" name="remove_logo" value="0"> --}}
                                    <input type="file" class="dropify  bg-dark @error('white_logo') is-invalid @enderror"
                                        name="white_logo" id="white_logo"
                                        data-default-file="@isset($setting){{ asset($setting->white_logo) }}@endisset">
                                    @error('white_logo')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
