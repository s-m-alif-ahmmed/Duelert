            ...
            <a href="{{ route('user.index') }}" class="card-link">
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h3 class="mb-2 fw-semibold">{{ $total_plan }}</h3>
                                <p class="text-muted fs-13 mb-0">Total Plans</p>
                            </div>
                            <div class="col col-auto top-icn dash">
                                <div class="counter-icon bg-primary dash ms-auto box-shadow-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            ...
            <a href="{{ route('user.index') }}" class="card-link">
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h3 class="mb-2 fw-semibold">{{ $total_subscription }}</h3>
                                <p class="text-muted fs-13 mb-0">Total Subscription</p>
                            </div>
                            <div class="col col-auto top-icn dash">
                                <div class="counter-icon bg-primary dash ms-auto box-shadow-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            ...
            <a href="{{ route('user.index') }}" class="card-link">
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h3 class="mb-2 fw-semibold">{{ $total_blog }}</h3>
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-6">
                <div class="card-style mb-10">
                    ...
                    <hr>
                    <div class="chart-container">
                        <canvas id="subscription-line-chart"></canvas>
...
@push('scripts')
    ...
    {{-- chart for subscription start --}}
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const labels = @json($subscriptionData['labels']); // 12 months
            const data = @json($subscriptionData['data']);
            ...
            const backgroundColors = pointColors.map(c => c.replace('1)', '0.2)'));
    
            const ctx = document.getElementById('subscription-line-chart').getContext('2d');
