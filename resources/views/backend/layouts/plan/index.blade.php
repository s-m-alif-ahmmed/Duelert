        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom"
                    ...
                    <h3 class="card-title">Plan Table</h3>
                    {{-- <a href="{{ route('plan.create') }}" class="btn btn-primary">Add New</a> --}}
                </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom w-100" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Plan Code</th>
                                    <th class="wd-15p border-bottom-0">Currency</th>
                                    <th class="wd-15p border-bottom-0">Price</th>
                                    <th class="wd-20p border-bottom-0">SMS Limit</th>
                                    <th class="wd-15p border-bottom-0">Customize Birth Message</th>
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'customize_birth_message',
                            name: 'customize_birth_message',
                            orderable: true,
                            searchable: true
                        },
                        {
